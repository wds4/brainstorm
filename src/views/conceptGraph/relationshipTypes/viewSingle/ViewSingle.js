...
const ViewSingleRelationshipType = () => {
  const oWords = useSelector((state) => state.conceptGraph.words)
  const viewWordCid = useSelector((state) => state.siteNavigation.conceptGraph.viewRelationshipType)
...
export default ViewSingleRelationshipType
